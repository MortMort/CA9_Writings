...
\title[Rotational Speed Control of Floating Wind Turbines]% optional, use only with long paper titles
{Rotational Speed Control of Floating Wind Turbines}
...
%\input{Topics/theoBack}

\section{Modelling}
\input{Topics/modelling}

\section{Controller Design}
\input{Topics/ctrlDesign}
