...
\begin{figure}[ht]
	...
	\caption{The 6 additional degrees of freedom (DOFs) of a floating offshore wind turbine. While it is the correct foundation structure but but the turbine might not be exactly the turbine modelled in this report}
