...
Can a model linearised at an operating point capture the fore-aft motion dynamics of a floating wind turbine well enough to be used for fore-aft motion damping in a rotor speed controller.